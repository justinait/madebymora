...
function HeroProjects({ onCategoryChange }) {
  ...
  const extraProjects = [
    {   name: "CHOCOLATE EN RAMA", image: "/src/assets/images/photography/photo1.webp", detail2: "PHOTOGRAPHY", brand:["Photos"], "year":"2024"   },
    {   name: "REVOLUTION 909", image: "/src/assets/images/photography/photo7.webp", detail2: "PHOTOGRAPHY", brand:["Photos"], "year":"2024"       }
  ]
